...
public class MultipartFilter implements Filter {
	...
	/**
	 * Parse the given HttpServletRequest. If the request is a multipart request,
	 * then all multipart request items will be processed, else the request will be
	 * returned unchanged. During the processing of all multipart request items, the
	 * name and value of each regular form field will be added to the parameterMap
	 * of the HttpServletRequest. The name and File object of each form file field
	 * will be added as attribute of the given HttpServletRequest. If a
	 * FileUploadException has occurred when the file size has exceeded the maximum
	 * file size, then the FileUploadException will be added as attribute value
	 * instead of the FileItem object.
	 * 
	...
	private HttpServletRequest parseRequest(HttpServletRequest request) throws ServletException {
		...
		// I'd rather call the "FileItem" class "MultipartItem" instead or so. What a
		// stupid name ;)
		...
		try {
			...
			// Note: we could use ServletFileUpload#setFileSizeMax() here, but that would
			// throw a
	...
	/**
	 * Process multipart request item as regular form field. The name and value of
	 * each regular form field will be added to the given parameterMap.
	 * 
	...
	/**
	 * Process multipart request item as file field. The name and FileItem object of
	 * each file field will be added as attribute of the given HttpServletRequest.
	 * If a FileUploadException has occurred when the file size has exceeded the
	 * maximum file size, then the FileUploadException will be added as attribute
	 * value instead of the FileItem object.
	 * 

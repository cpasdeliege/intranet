...
public class GestionPlanningToDo implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest arg0,
		...
		arg0.getSession().setAttribute("retour", "gestionPlanningToDo.admin");
		
		return new ModelAndView("gestionPlanningToDo", modele);

...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a
	...
	class="menu_contextuel">${ formation.intitule }</a>
<hr>
</div>
<br>
<table cellpadding="0" cellspacing="0" class="tableau_container_centre">
	<tr height="25">
		...
		<table width="100%">
			<tr>
				<td width="45px"><img src="images/formation.png" border="0"
					width="35px"></td>
	...
	<tr>
		...
		<table class="tableau_liste" cellspacing="0">
			<tr>
				<td align="right" style="font-weight: bold" valign="top"><nobr>typologie
				:&nbsp;&nbsp;</nobr></td>
			...
			<tr>
				<td align="right" style="font-weight: bold" valign="top"><nobr>rapport
				:&nbsp;&nbsp;</nobr></td>

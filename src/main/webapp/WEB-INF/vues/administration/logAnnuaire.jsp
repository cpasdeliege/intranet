...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a class="menu_contextuel">logs annuaire</a>
<hr>
</div>
<br>
		...
		<td>
			<table width="100%">
				<tr>
					...
					<td class="titre_tableau">Logs annuaire</td>
					<td align="right">

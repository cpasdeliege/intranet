...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a class="menu_contextuel">logs formations</a>
<hr>
</div>
<br>
		...
		<td>
			<table width="100%">
				<tr>
					...
					<td class="titre_tableau">Logs formations administration</td>
					<td align="right">
	...
	<tr>
		...
		<td>
			<table class="tableau_liste" cellspacing="0">
				...
				<% } %>
						<td width="180px"><nobr>${log.date}</nobr></td>
						<td width="80px">${log.user}</td>
						<td>${log.request}</td>

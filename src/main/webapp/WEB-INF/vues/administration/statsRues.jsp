...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a class="menu_contextuel">statistiques répartition et code des rues de Liège</a>
<hr>
</div>
<br>
		...
		<td>
			<table width="100%">
				<tr>
					...
					<td class="titre_tableau">Statistiques répartition et code des rues de Liège</td>
					<td align="right">

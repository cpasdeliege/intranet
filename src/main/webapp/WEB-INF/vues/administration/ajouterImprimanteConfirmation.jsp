...
<table cellpadding="0" cellspacing="0"  class="tableau_container">
	<tr height="25">
		...
		<td>
			<table>
				<tr>
					<td class="titre_tableau">Confirmation - Ajout d'une imprimante</td>
					<td>
					</td>
				</tr>
			</table>
		...
		<td>
			<table class="tableau_liste">
				<tr>
					...
					<td class="texte_tableau_confirmation">${ formulaireImprimanteAjouter.numeroSerie }</td>
				</tr>
				<tr>
					<td align="right">type : </td>
					<td class="texte_tableau_confirmation">${ formulaireImprimanteAjouter.type }</td>
				</tr>
				<tr>
					<td align="right">ordinateur local : </td>
					<td class="texte_tableau_confirmation">${ formulaireImprimanteAjouter.ordinateurLocal }</td>
				</tr>
				<tr>
					<td></td>
					<td>&nbsp;</td>
				...
				<tr>
					<td>
						<a href="formulaireImprimanteAjouter.admin"><img alt="retour" src="images/administration/retour.jpg" border="0"></a>
					</td>
					<td align="right">
						<form method="get" action="ajouterImprimante.admin">

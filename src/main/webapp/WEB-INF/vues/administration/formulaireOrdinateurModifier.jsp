...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a class="menu_contextuel" href="gestionOrdinateur.admin?ordinateur=${ formulaireOrdinateurModifier.nom }">${ formulaireOrdinateurModifier.nom }</a>
...
<table cellpadding="0" cellspacing="0"  class="tableau_container">
	<tr height="25">
		...
		<td>
			<table>
				<tr>
					<td class="titre_tableau">Modification d'un ordinateur</td>
					<td>
					</td>
				</tr>
			</table>
		...
		<td>
			...
			<table>
				<tr>
					...
					<td><input disabled="disabled" type="text" maxlength="200" name="nom" value="${ formulaireOrdinateurModifier.nom }"/> 
					
					
					<c:choose>
						<c:when test="${formulaireOrdinateurModifier.actif == 1}">
							<input checked="checked" type="checkbox" name="actif" /> actif </td>
						</c:when>
						<c:otherwise>
							<input type="checkbox" name="actif" /> actif </td>
						</c:otherwise>
					</c:choose>
					...
					<td>
						<select name="service" size="1" />
							...
							<c:forEach items="${listeService}" var="service">
								<c:choose>
									<c:when test="${formulaireOrdinateurModifier.service == service.nom}">
				...
				<tr>
					...
					<td><input type="text" maxlength="200" name="prise" value="${ formulaireOrdinateurModifier.prise }"/></td>
				</tr>
				<tr>
					<td align="right">numéro CPAS2000 : </td>
					<td><input type="text" maxlength="200" name="numCpas2000" value="${ formulaireOrdinateurModifier.numCpas2000 }"/></td>
				</tr>
				<tr>
					...
					<td>
						<select name="systemeExploitation" size="1" />
							<c:forEach items="${typeOS}" var="type">
								<c:choose>
									<c:when test="${formulaireOrdinateurModifier.systemeExploitation == type.nom}">
				...
				<tr>
					...
					<td><input type="text" maxlength="200" name="carteMere" value="${ formulaireOrdinateurModifier.carteMere }"/></td>
				</tr>
				<tr>
					<td align="right">processeur : </td>
					<td><input type="text" maxlength="200" name="processeur" value="${ formulaireOrdinateurModifier.processeur }"/></td>
				</tr>
				<tr>
					<td align="right">mémoire ram : </td>
					<td><input type="text" maxlength="200" name="memoireRam" value="${ formulaireOrdinateurModifier.memoireRam }"/></td>
				</tr>
				<tr>
					<td align="right">carte graphique : </td>
					<td><input type="text" maxlength="200" name="carteGraphique" value="${ formulaireOrdinateurModifier.carteGraphique }"/></td>
				</tr>
				<tr>
					<td align="right">disque dur : </td>
					<td><input type="text" maxlength="200" name="disqueDur" value="${ formulaireOrdinateurModifier.disqueDur }"/></td>
				</tr>
				<tr>
					...
					<td>
						<select name="graveur" size="1" />
							<c:forEach items="${typeGraveur}" var="graveur">
								<c:choose>
									<c:when test="${formulaireOrdinateurModifier.graveur == graveur.graveur}">
				...
				<tr>
					...
					<td><input type="text" maxlength="200" name="carteReseau" value="${ formulaireOrdinateurModifier.carteReseau }"/></td>
				</tr>
				<tr>
					...
					<td>
						<select name="ecran" size="1" />
							<c:forEach items="${typeEcran}" var="ecran">
								<c:choose>
									<c:when test="${formulaireOrdinateurModifier.ecran == ecran.ecran}">
			...
			<input type="hidden" name="nom" value="${ formulaireOrdinateurModifier.nom }"/>

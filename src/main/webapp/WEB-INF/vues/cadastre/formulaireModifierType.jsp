...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a class="menu_contextuel">Modifier un type de Marché Public</a>
		<hr>
	</div>
<div id="principal">
...
<table cellpadding="0" cellspacing="0"  class="tableau_container">
	<tr height="25">
		...
		<td>
			<table>
				<tr>
					<td class="titre_tableau">Modifier un type de marché public</td>
					<td>
					</td>
				</tr>
			</table>
	...
	<tr>
		...
		<td>
			<!-- <form method="post" action="index.cad?action=modifierType" name="formulaire" >  -->
			...
			<table>
				...
				<tr>
					...
					<td>
						<input type="hidden" name="action" value="modifierTypeCadastre">
				...
				<input type="hidden" name="id_type_marche" value="${typeMarche.id_type_marche}">
			</form>
		</td>

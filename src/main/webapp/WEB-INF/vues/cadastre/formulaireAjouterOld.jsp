...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a class="menu_contextuel">Ajouter Marché Public</a>
		<hr>
	</div>
<div id="principal">
...
<table cellpadding="0" cellspacing="0"  class="tableau_container">
	<tr height="25">
		...
		<td>
			<table>
				<tr>
					<td class="titre_tableau">Ajouter un marché public</td>
					<td>
					</td>
				</tr>
			</table>
	...
	<tr>
		...
		<td>
			<form method="post" action="index.cad?action=ajouterMP" name="formulaire" >
			<table>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<select name="reference" size="1" />
							<option>-----> choisir une dénomination</option>
							
							<%
								for(int i = 0; i < listeDenomination.size(); i++) {
									if(listeDenomination.get(i).getDenomination().equals(marche.getReference())) {
							%>		
									<option selected value="<%= listeDenomination.get(i).getDenomination() %>"><%= listeDenomination.get(i).getDenomination() %></option>
							<%
									} else {
							%>
									<option value="<%= listeDenomination.get(i).getDenomination() %>"><%= listeDenomination.get(i).getDenomination() %></option>
							<%
									}
								}
							%>
				...
				<tr>
					<td align="right">P. Adjudicateur : </td>

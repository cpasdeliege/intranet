...
<body class="body">
	...
	<div>
		<%
			PrivilegeInformatique privilege = (PrivilegeInformatique) session
					.getAttribute("privilegeInformatique");
			//List<DemServInf> listeDsi = (List<DemServInf>)request.getAttribute("listeDsi");
			List<DemServInf> nouvelles = (List<DemServInf>) request
					.getAttribute("listeDsiNouvelles");
			List<DemServInf> validUser = (List<DemServInf>) request
					.getAttribute("listeDsiValidUser");
			List<DemServInf> validInfo = (List<DemServInf>) request
					.getAttribute("listeDsiValidInfo");
			
			List<DemServInf> validInfoEnAttente = (List<DemServInf>) request
			.getAttribute("listeDsiValidInfoEnAttente");
			
			
			List<DemServInf> conf = (List<DemServInf>) request
					.getAttribute("listeDsiConf");
			List<DemServInf> acceptees = (List<DemServInf>) request
					.getAttribute("listeDsiAcceptees");
			List<DemServInf> executees = (List<DemServInf>) request
					.getAttribute("listeDsiExecutees");
			List<DemServInf> attente = (List<DemServInf>) request
					.getAttribute("listeDsiAttente");
			List<DemServInf> refusees = (List<DemServInf>) request
					.getAttribute("listeDsiRefusees");
			StatDem stat = (StatDem) request
			.getAttribute("StatDem");
		%>
		<hr>
	...
	<tr height="25">
		...
		<tr height="25">
			...
			<td>
				<table width="100%">
					<tr>
						<td width="30px"><img src="images/dsi.png" border="0"
							width="35px">
						</td>
						<td class="titre_tableau"><a name="nouvelles">Liste des
								nouvelles demandes (<%=nouvelles.size()%>)</a>
						</td>
						<td align="right">
			...
			<td>
				<table class="tableau_liste" cellspacing="0">
					<tr class="titre_colonne_tableau_liste">
						...
						<th>Titre</th>
						<th><a href="index.dsi?orderby=nom#nouvelles">Auteur
								Demande</a>
						</th>
						<th><a href="index.dsi?orderby=service#nouvelles">Service</a>
						</th>
						<th><a href="index.dsi?orderby=nomChef#nouvelles">Responsable</a>
						</th>
						<th><a href="index.dsi?orderby=dateDemande#nouvelles">Date
								Demande</a>
						</th>
						<%
					...
					<c:forEach items="${listeDsiNouvelles}" var="dsi">
						...
						<tr class="ligne_impaire"
							...
							<%
								if (privilege.isDsiChef()) {
							%><td><a
								href="index.dsi?action=supprimer&amp;idDemandes=${dsi.idDemandes}"><img
									alt="supprimer" src="images/administration/supprimer.gif"
									border="0">
							</a>
							</td>
							<%
		...
		<tr height="25">
			...
			<td>
				<table width="100%">
					<tr>
						<td width="30px"><img src="images/confirmation.png"
							border="0" width="35px">
						</td>
						<td class="titre_tableau"><a name="validUser">Liste des
								demandes en attente de validation (<%=validUser.size()%>)</a>
						</td>
						<td align="right"></td>
					</tr>
				</table></td>
			...
			<td>
				<table class="tableau_liste" cellspacing="0">
					<tr class="titre_colonne_tableau_liste">
						...
						<th>Titre</th>
						<th><a href="index.dsi?orderby=nom#validUser">Auteur
								Demande</a>
						</th>
						<th><a href="index.dsi?orderby=service#validUser">Service</a>
						</th>
						<th><a href="index.dsi?orderby=nomChef#validUser">Responsable</a>
						</th>
						<th><a href="index.dsi?orderby=dateDemande#validUser">Date
								Demande</a>
						</th>
					</tr>
					<%
		...
		<tr height="25">
			...
			<td>
				<table width="100%">
					<tr>
						<td width="30px"><img src="images/informatique.png"
							border="0" width="35px">
						</td>
						<td class="titre_tableau"><a name="validInfo">Liste des
								demandes en attente de validation du service informatique (<%=validInfo.size()%>)</a>
						</td>
						<td align="right"></td>
					</tr>
				</table></td>
			...
			<td>
				<table class="tableau_liste" cellspacing="0">
					...
					<%
						int j = 0;
					%>
					<c:forEach items="${listeDsiValidInfo}" var="dsi">
						<%
							j++;
						%>
						<%
			...
			<td>
				<table class="tableau_liste" cellspacing="0">
					...
					<%
						int j = 0;
					%>
					<c:forEach items="${listeDsiValidInfoEnAttente}" var="dsi">
						<%
							j++;
						%>
						<%
			...
			<td>
				<table width="100%">
					<tr>
						...
						<td class="titre_tableau"><a name="confSecr">Liste des
								demandes pour confirmation (<%=conf.size()%>)</a>
						</td>
						<td align="right"></td>
					</tr>
				</table></td>
			...
			<td>
				<table class="tableau_liste" cellspacing="0">
					<tr class="titre_colonne_tableau_liste">
						...
						<th>Titre</th>
						<th><a href="index.dsi?orderby=nom#confSecr">Auteur
								Demande</a>
						</th>
						<th><a href="index.dsi?orderby=service#confSecr">Service</a>
						</th>
						<th><a href="index.dsi?orderby=nomChef#confSecr">Responsable</a>
						</th>
						<th><a href="index.dsi?orderby=dateDemande#confSecr">Date
								Demande</a>
						</th>
					</tr>
					<%
						int j = 0;
					%>
					<c:forEach items="${listeDsiConf}" var="dsi">
						<%
							j++;
						%>
						<%
		...
		<tr height="25">
			...
			<td>
				<table width="100%">
					<tr>
						<td width="30px"><img src="images/accepte.png" border="0"
							width="35px">
						</td>
			...
			<td>
				<table class="tableau_liste" cellspacing="0">
					<tr class="titre_colonne_tableau_liste">
						...
						<th></th>
						<% } %>
						<!-- <th><a href="index.dsi?orderby=typeDemande#acceptees">Type</a>
						</th>  -->
						<th>Titre</th>
						<th><a href="index.dsi?orderby=nom#acceptees">Auteur
								Demande</a>
						</th>
						<th><a href="index.dsi?orderby=service#acceptees">Service</a>
						</th>
						<!-- <th><a href="index.dsi?orderby=nomChef#acceptees">Responsable</a>
						</th>  -->
						<th><a
					...
					<c:forEach items="${listeDsiAcceptees}" var="dsi">
						...
						<tr class="ligne_impaire"
							...
							<%
								if (privilege.isDsiInfo()) {
							%>
							<td width="45px" align="center"><c:forEach items="${dsigti}" var="gti">

									<c:choose>
										<c:when test="${gti.idDemande == dsi.idDemandes}">
											
											<c:choose>
												<c:when test="${gti.fini == 0}">
													<a style="color: red;" href="gestionTache.admin?idPlanning=${gti.idPlanning}">${gti.idPlanning}</a>
												</c:when>
												<c:otherwise>
													<a style="color: green;" href="gestionTache.admin?idPlanning=${gti.idPlanning}">${gti.idPlanning}</a>
												</c:otherwise>
											</c:choose>
										</c:when>
										<c:otherwise>

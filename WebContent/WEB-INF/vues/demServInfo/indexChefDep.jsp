...
<tr height="25">
	...
	<tr height="25">
		...
		<td>
			<table width="100%">
				<tr>
					<td width="30px"><img src="images/informatique.png" border="0" width="35px"></td>
					<td class="titre_tableau"><a name="validInfo">Liste des demandes en attente de validation du service informatique (<%= validInfo.size() %>)</a></td>
					<td align="right">
	...
	<tr>
		...
		<td>
			<table class="tableau_liste" cellspacing="0">
				<tr class="titre_colonne_tableau_liste">
					<th><a href="index.dsi?orderby=idDemandes#validInfo">n°</a></th>
					<th><a href="index.dsi?orderby=typeDemande#validInfo">Type</a></th>
					<th>Titre</th>
					<th><a href="index.dsi?orderby=nom#validInfo">Auteur Demande</a></th>
					<th><a href="index.dsi?orderby=service#validInfo">Service</a></th>
					<th><a href="index.dsi?orderby=nomChef#validInfo">Responsable</a></th>
					<th><a href="index.dsi?orderby=dateDemande#validInfo">Date Demande</a></th>
				</tr>
				<% int j = 0; %>
	...
	<tr height="25">
		...
		<td>
			<table width="100%">
				<tr>
					<td width="30px"><img src="images/confirmation.png" border="0" width="35px"></td>
					<td class="titre_tableau"><a name="confSecr">Liste des demandes pour confirmation (<%= conf.size() %>)</a></td>
					<td align="right">
	...
	<tr>
		...
		<td>
			<table class="tableau_liste" cellspacing="0">
				<tr class="titre_colonne_tableau_liste">
					<th><a href="index.dsi?orderby=idDemandes#confSecr">n°</a></th>
					<th><a href="index.dsi?orderby=typeDemande#confSecr">Type</a></th>
					<th>Titre</th>
					<th><a href="index.dsi?orderby=nom#confSecr">Auteur Demande</a></th>
					<th><a href="index.dsi?orderby=service#confSecr">Service</a></th>
					<th><a href="index.dsi?orderby=nomChef#confSecr">Responsable</a></th>
					<th><a href="index.dsi?orderby=dateDemande#confSecr">Date Demande</a></th>
				</tr>
				<% int j = 0; %>

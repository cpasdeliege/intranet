...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a class="menu_contextuel">statistiques intranet</a>
<hr>
</div>
<br>
		...
		<td>
			<table width="100%">
				<tr>
					...
					<td class="titre_tableau">Statistiques intranet</td>
					<td align="right">
		...
		<td>
			<table cellspacing="5">
				...
				<tr>
					...
					<td width="80" align="right">${statsIntranet.pagesTotal }</td>
					<td width="120" align="right">${statsIntranet.ordinateursTotal }</td>
				</tr>
				<tr>
					<td>Ajourd'hui</td>
					<td align="right">${statsIntranet.pagesAujourdhui }</td>
					<td align="right">${statsIntranet.ordinateursAujourdhui }</td>
				</tr>
				<tr>
					<td>Hier</td>
					<td align="right">${statsIntranet.pagesHier }</td>
					<td align="right">${statsIntranet.ordinateursHier }</td>
				</tr>
			</table>
		</td>

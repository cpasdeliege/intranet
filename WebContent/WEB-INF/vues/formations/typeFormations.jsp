...
<img height="12px" src="images/fleche_droite.jpg" border="0" alt=" - "><a
	...
	class="menu_contextuel">recherche par type de formation</a>
<hr>
</div>
<table align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td align="center"><a class="lien_navigation_actif">recherche
		par type de formation</a> - <a class="lien_navigation"
			href="services.formations">service</a></td>
			...
			<tr>
				...
				<table>
					<c:forEach items="${colonneType1}" var="type">
						<tr>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
								href="typeFormations.formations?typeFormation=${type.nom}#debut"
								class="lien_sous_navigation">${type.nom}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						</tr>
					</c:forEach>
				</table>
				</td>
...
if (request.getParameter("typeFormation") != null) {
		...
		<table width="100%">
			<tr class="titre_tableau" valign="bottom">
				<td width="50px"><img src="images/formation.png" border="0"
					width="40px"></td>
				<td><a name="debut"><%= request.getParameter("typeFormation") %></a></td>
